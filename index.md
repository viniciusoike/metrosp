...
reads the newer data. Every pipeline run publishes a fresh build of the
four demand datasets to the rolling [`data-latest`
...
Columns match the bundled datasets, so the same code works with either.
