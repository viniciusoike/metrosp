...
For more details check the [Data
Dictionary](https://viniciusoike.github.io/metrosp/articles/data-dictionary.html)
and the [package’s Getting Started
vignette](https://viniciusoike.github.io/metrosp/articles/getting_started.html).

### Explorer dashboard

To explore and analyze this data check the [Metro Explorer
dashboard](https://viniciusoike-metrosp-explorer.share.connect.posit.cloud).
