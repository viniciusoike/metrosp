...
- **Entrada de passageiros** (*passenger entries*): passengers entering through the turnstile gates (*linha de bloqueios*). A passenger enters once, so summing lines gives a network entry count.
