...
For convinence, `metrosp` also provides information on stations and lines of the metro system (`lines`, `stations`, and `metro_lines`). The `lines` dataset is a spatial dataset and requires the `sf` package to work properly.
