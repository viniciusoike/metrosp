...
analysing it. For auxiliary lookup tables (`metro_colors`,
`station_inauguration`), see the help pages (e.g., `?metro_colors`).
...
columns on every passenger and station dataset, and the full network line
list (including planned and CPTM lines) is available in `lines`.
