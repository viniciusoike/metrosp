...
- `metro_lines` is no longer exported. Its line-name columns
  ...
  passenger/station dataset, and the full line list (including planned
  and CPTM lines) is available in `lines`. It remains an internal join
  dimension in the ETL pipeline.
