...
caveats you should know before analyzing it. For the auxiliary lookup
tables, see the help pages
...
The package ships four core datasets. Two measure passengers at the line
level, and two at the station level.
...
figures here drift from the source over time. Freshly rebuilt data is
published on every pipeline run to the `data-latest` [GitHub
